...
def main() -> int:
    ...
    s.add_argument("--emotion", default="joy"); s.add_argument("--line", default="这片云像棉花糖！")
    ...
    if args.command == "photo":
        ...
        seen = link.position(); link.photo_replied(event, args.emotion, 0.9, args.line); print(link.wait_for("photo_ack", 1.0, since=seen))
